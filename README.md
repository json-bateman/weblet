...
background. Open **http://localhost:41234**.
...
```bash
ssh -L 41234:localhost:41234 user@your-server
```

Then open **http://localhost:41234** on your local machine. Add `-N -f` to run the
...
Host myserver
    ...
    User user
    LocalForward 41234 localhost:41234
```
...
Then open **http://localhost:41234**. Config is `WEBLET_`-prefixed (see
...
Then open **http://localhost:41234** on the Mac.
